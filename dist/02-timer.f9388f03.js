...
const options = {
    ...
    onClose (selectedDates, dateStr) {
        if (selectedDates[0] < Date.now()) {
            (0, _notiflixDefault.default).Notify.failure("Please, choose a future date");
            startButton.style.backgroundColor = "yellow";
            startButton.disabled = true;
        } else {
            startButton.style.backgroundColor = "green";
            (0, _notiflixDefault.default).Notify.success("Welcome to timer");
...
(0, _flatpickrDefault.default)(inputPicker, options);
